...
async def analyze_text_with_openai(data):
    ...
    try:
        ...
        Return only the detected emotion.send only emotion.do not send any other texts analyze the typing patterns.if you cannot identified emotion clearly send it as a happy
